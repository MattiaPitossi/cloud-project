...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.6.1/js/bootstrap.min.js"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-confirmation2/4.2.1/bootstrap-confirmation.min.js"
        integrity="sha512-LhgCuBuvISlfR3iVmjgchM6JrYvl16h/RJVsjdCfGXUahMHgmMJpavyIbluTuV3Ww8tJtGh2VAYayfoGvc84DA=="
        crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    </script>
...
<body>
            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    <a href="/index"
                        ...
                        <span class="fs-5 d-none d-sm-inline">Cloud Storage</span>
                    </a>
                    ...
                    <footer>
                        <small>©2022 Contact us at support@email.com </small>
                    </footer>
    ...
    <script>
        ...
        function sortTable(n) {
            ...
            table = document.getElementById("all-files");
            switching = true;
